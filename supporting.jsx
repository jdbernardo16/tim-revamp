                ...
                <Container>
                    <div className="vault-grid">
                        ...
                        <div>
                            ...
                            <h1
                                className="display"
                                dangerouslySetInnerHTML={html(d.title)}
                            />
                            <p
                                className="lead"
                                dangerouslySetInnerHTML={html(d.lead)}
                            />
                ...
                <Container narrow style={{ textAlign: "center" }}>
                    ...
                    <div className="cta-row centered">
                        ...
                        <Button
                            ...
                            onClick={() =>
                                goTo(
                                    d.closerCtaSecondaryRoute,
                                    d.closerCtaSecondaryParams,
                                )
                            }
                        >
                            {d.closerCtaSecondary}
                        </Button>
                    </div>
                </Container>
            </Section>
...
const FAQItem = ({ q, a, defaultOpen }) => {
    ...
    return (
        <div className={"faq-item" + (open ? " open" : "")}>
            ...
            {open && (
                <div className="faq-a" dangerouslySetInnerHTML={html(a)} />
            )}
        </div>
    );
};
    ...
    <Section tone="paper">
        <Container narrow style={{ textAlign: "center" }}>
            ...
            <Plate
                ...
                h={280}
                src={image || "assets/story-placeholder.jpg"}
                style={{ margin: "24px auto" }}
            />
            <Button primary onClick={() => goTo(ctaRoute || "home")}>
                {ctaLabel || "Back home"} →
            </Button>
        </Container>
    </Section>
        ...
        return (
            <Section tone="paper">
                <Container narrow style={{ textAlign: "center" }}>
                    ...
                    <p
                        className="lead"
                        dangerouslySetInnerHTML={html(S.confirmedBody)}
                    />
                    <Plate
                        label="thank you"
                        h={240}
                        src={S.confirmedImage || ""}
                        style={{ margin: "24px 0" }}
                    />
                    <Button primary onClick={() => goTo("home")}>
                        Back home →
                    </Button>
                </Container>
            </Section>
                ...
                <Container>
                    <div className="vault-grid">
                        <div>
                            ...
                            <h1
                                className="display"
                                dangerouslySetInnerHTML={html(S.heroTitle)}
                            />
                            ...
                            <div className="cta-row">
                                ...
                                <Button
                                    ...
                                    onClick={() =>
                                        goTo(
                                            S.heroCtaSecondaryRoute,
                                            S.heroCtaSecondaryParams,
                                        )
                                    }
                                >
                                    {S.heroCtaSecondary}
            ...
            <Section tone="ink">
                <Container narrow style={{ textAlign: "center" }}>
                    ...
                    <h2
                        className="display"
                        style={{ color: "inherit" }}
                        dangerouslySetInnerHTML={html(S.reelTitle)}
                    />
                    <div className="reel-frame" onClick={() => setShowReel(true)}>
                        <Plate
                            label="▶ play speaker reel"
                            h={420}
                            src={S.reelImage || ""}
                            style={{
                                background: S.reelImage ? "none" : "#222",
                    ...
                    {showReel && (
                        <div className="modal-overlay" onClick={() => setShowReel(false)}>
                            <div className="modal-video" onClick={(e) => e.stopPropagation()}>
                                <button className="modal-close" onClick={() => setShowReel(false)}>×</button>
                                <video controls autoPlay playsInline style={{ width: "100%", height: "auto", display: "block" }}>
            ...
            <Section tone="cream">
                <Container>
                    <div className="center-head">
                        ...
                        <h2
                            className="display"
                            dangerouslySetInnerHTML={html(S.eventsTitle)}
                        />
                        <p className="lead">{S.eventsLead}</p>
                    </div>
                    <div className="featured-grid">
                        {(S.featuredOn || []).map((f, i) => (
            ...
            <Section tone="paper">
                <Container>
                    <div className="center-head">
                        ...
                        <h2
                            className="display"
                            dangerouslySetInnerHTML={html(S.talksTitle)}
                        />
                        ...
                        {(S.talks || []).map((t, i) => (
                            <article key={i} className="talk-card">
                                ...
                                <div className="talk-meta">
                                    <span>
                                        <span className="meta-k">LENGTH</span>
                                        {t.time}
                                    </span>
                                    <span>
                ...
                <Container>
                    <div className="inquiry-grid">
                        <div>
                            ...
                            <h2
                                className="display"
                                dangerouslySetInnerHTML={html(S.inquiryTitle)}
                            />
                        ...
                        >
                            ...
                            <div className="row-2">
                                ...
                                <Field
                                    label="Organization"
                                    placeholder="Your company / event"
                                    value={form.org}
                                    onChange={(v) =>
                                        setForm({ ...form, org: v })
                                    }
                            ...
                            <label className="field">
                                ...
                                >
                                    ...
                                    <option>
                                        Corporate offsite / leadership team
                                    </option>
                                </select>
                            </label>
                            ...
                            <div className="row-2">
                                <Field
                                    label="Event date(s)"
                                    placeholder="Sept 14, 2026 (or window)"
                                    value={form.date}
                                    onChange={(v) =>
                                        setForm({ ...form, date: v })
                                    }
                            ...
                            <label className="field">
                                <span className="field-label">
                                    Anything else? (audience, theme, dream talk)
                                </span>
                                <textarea
            ...
            <Section tone="cream">
                <Container narrow style={{ textAlign: "center" }}>
                    ...
                    <h3
                        ...
                        dangerouslySetInnerHTML={html(S.relatedTitle)}
                    />
                    <Button
                        primary
        ...
        <Section tone="paper">
            <Container narrow style={{ textAlign: "center" }}>
                ...
                <h1 className="display">
                    All <span className="u">programs.</span>
                </h1>
                <p className="lead">
                    Every offer in one place — pick by phase, price, or path.
                </p>
            </Container>
        </Section>
        <Section tone="cream">
            <Container>
                <div className="all-prog-grid">
                    {(
                        (window.GLOBAL && window.GLOBAL.allProgramIds) ||
                        ...
                        return (
                            <button
                                key={id}
                                type="button"
                                className="all-prog-card"
                                onClick={() => goTo("product", { id })}
                            >
                                {p.phase && (
                                    <span className="prod-phase">
                                        {p.phase}
                                    </span>
                                )}
                                {!p.phase && p.kind === "lead-magnet" && (
                                    <span className="prod-phase">$29</span>
                                )}
                                {!p.phase && p.kind === "free" && (
                                    <span className="prod-phase">FREE</span>
                                )}
                                {!p.phase && p.kind === "private" && (
                                    <span className="prod-phase">PRIVATE</span>
                                )}
